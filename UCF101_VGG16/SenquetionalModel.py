...
label_data = pd.read_csv("C:\\Users\\karen\\PhD\\UCF101_VGG16\\ucfTrainTestlist\\classInd.txt", sep=' ', header=None)
...
for label in label_data.labels.values:
    path.append('C:\\Users\\karen\\PhD\\UCF101_VGG16\\UCF-101\\'+label+"\\")
print(path[0])
...
model.save('C:\\Users\\karen\\PhD\\UCF101_VGG16\\Model\\CNN_Model.h5')